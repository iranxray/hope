...
در راهنمای امید راه‌کار [استفاده از Cloudflare CDN](https://github.com/iranxray/hope/blob/main/cloudflare-cdn.md) را توضیح داده‌ایم. این روش به برخی از کاربران کمک خواهد کرد تا شانس شناسایی سرور‌شان کمتر شود.
