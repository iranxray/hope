...
ایده‌ال ترین حالت این است که اساسا ترافیک داخلی ایران به سمت پروکسی سرور شما ارسال نشود. مثلا اپلیکیشن V2Ray‌ برای ما این امکان را فراهم می‌کند که به سادگی مشخص کنیم ترافیک داخلی از پروکسی عبور نکند و فقط ترافیک خارجی به سمت پروکسی سرور ارسال شود.
...
می‌توانیم مسدودسازی رو در سمت سرور هم انجام بدهیم. ما توصیه می‌کنیم این کار حتما صورت بگیرد چون مواقعی هست که به دلایل مختلف مسدودسازی از سمت کاربر مقدور نیست و شما هم نمی‌توانید به کاربران‌تون اطمینان داشته باشید که حتما مسدودسازی رو انجام داده‌اند. 
