...
این قسمت مسئولیت شما است. ما می‌توانیم مسدودسازی را در سمت سرور هم انجام دهیم. توصیه می‌کنیم این کار حتما صورت بگیرد زیرا مواقعی است که به دلایل مختلف مسدودسازی از سمت کاربر مقدور نیست و شما هم نمی‌توانید به کاربران خود اطمینان داشته باشید که حتما مسدودسازی را انجام داده‌اند. 
