...
صفحه رو اسکرول کنید و پایین تر بروید. حالا نوبت به انتخاب محل server رسیده. ما توصیه می‌کنیم که server شما در نزدیک‌ترین فاصله به ایران باشد. هر جایی در اروپا و آسیا می‌تواند مناسب باشد. در اینجا ما دهلی هند را انتخاب کردیم اما شما می‌توانید هر جایی که دوست دارید را انتخاب کنید.
